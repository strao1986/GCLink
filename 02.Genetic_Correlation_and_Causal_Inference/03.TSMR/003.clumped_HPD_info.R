...
exptran <- c("BAD")
outtran <- c("anxiety2018","anxiety2021")

info_clumped <- data.frame()
datapath <- "E:/Projects_documents/05.allergic_diseases_mental_disorders/01.anxiety_ADs/01.MR/02.5e-6/4.0.BAD/BAD_anxiety/"

outtran_tmp <- c("anxiety2021")  #only focus on the number of exposure clumped SNPs 
